...
export function LoansChapter() {
  return (
    <PageLayout>
      ...
      <LessonBlock title="1. מהות ההלוואות וחתך ריבית">
        <p>
          התחייבויות לטווח ארוך הן התחייבויות שמועד פירעונן עולה על שנה מיום המאזן. 
          כאשר חברה לוקחת הלוואה מהבנק, היא מקבלת מזומן ויוצרת התחייבות (קרן ההלוואה). 
          בנוסף, ההלוואה נושאת ריבית שמהווה הוצאת מימון.
        </p>
        <p>
          <strong>חתך ריבית:</strong> עקרון ההקבלה והבסיס המצטבר בחשבונאות מחייבים אותנו לרשום הוצאות ריבית 
          על פני התקופה שבה הכסף שימש את החברה, ללא קשר למועד התשלום בפועל במזומן. 
          אם חברה משלמת ריבית פעם בשנה ב-1 ביולי, הרי שביום המאזן (31.12) החברה חייבת לרשום 
          "הוצאות ריבית" על החציון שהסתיים (1.7 עד 31.12) וליצור התחייבות שוטפת שנקראת "ריבית לשלם".
        </p>
        <p>
          <strong>חלויות שוטפות של הלוואות לזמן ארוך:</strong> כאשר מועד פירעון ההלוואה (או חלק ממנה) 
          מגיע להיות פחות משנה מיום המאזן, יש להעביר את הסכום שצפוי להיות משולם בשנה הקרובה 
          מהסעיף "התחייבויות לזמן ארוך" לסעיף "התחייבויות שוטפות".
        </p>
      </LessonBlock>
        ...
        >
          <div className="space-y-10">
            ...
            <div className="border border-[var(--accent)]/30 bg-[var(--accent)]/5 rounded-xl p-6">
              ...
              <div className="bg-[var(--surface)] border border-[var(--surface-alt)] rounded-lg p-4">
                <h4 className="font-bold text-[var(--text)] mb-2">הצגה בדוחות הכספיים ליום 31.12.18</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <h5 className="font-semibold text-[var(--text-muted)] mb-1">מאזן</h5>
                    <ul className="space-y-1">
                      <li><span className="font-semibold">התחייבויות שוטפות:</span> ריבית לשלם - 5,000</li>
                      <li><span className="font-semibold">התחייבויות לזמן ארוך:</span> הלוואה - 200,000</li>
                    </ul>
                  </div>
                  <div>
                    <h5 className="font-semibold text-[var(--text-muted)] mb-1">דוח רווח והפסד</h5>
                    <ul className="space-y-1">
                      <li><span className="font-semibold">הוצאות מימון (ריבית):</span> 5,000</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            {/* 2019 */}
            <div className="border border-[var(--accent)]/30 bg-[var(--accent)]/5 rounded-xl p-6">
              <h3 className="text-xl font-bold text-[var(--accent)] mb-4 border-b border-[var(--accent)]/20 pb-2">שנת 2019</h3>
              <p className="text-[var(--text-muted)] text-sm mb-4">
                ב-1.7.19 משלמים ריבית עבור שנה שלמה (10,000). מחציתה (5,000) היא סגירת ההתחייבות משנת 2018, ומחציתה הוצאה על חציון ראשון של 2019. 
                ב-31.12.19 שוב עושים חתך ריבית על חציון שני.
              </p>
              ...
              <div className="bg-[var(--surface)] border border-[var(--surface-alt)] rounded-lg p-4">
                <h4 className="font-bold text-[var(--text)] mb-2">הצגה בדוחות הכספיים ליום 31.12.19</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <h5 className="font-semibold text-[var(--text-muted)] mb-1">מאזן</h5>
                    <ul className="space-y-1">
                  ...
                  <div>
                    <h5 className="font-semibold text-[var(--text-muted)] mb-1">דוח רווח והפסד</h5>
                    <ul className="space-y-1">
                      <li><span className="font-semibold">הוצאות מימון (ריבית):</span> 10,000</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="border border-[var(--color-warning)]/30 bg-[var(--color-warning)]/5 rounded-xl p-6 relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-[var(--color-warning)] text-[var(--bg)] text-xs font-bold px-3 py-1 rounded-bl-lg">
                שים לב לשינוי סיווג במאזן!
              </div>
              <h3 className="text-xl font-bold text-[var(--color-warning)] mb-4 border-b border-[var(--color-warning)]/20 pb-2">שנת 2020</h3>
              <p className="text-[var(--text-muted)] text-sm mb-4">
                ב-31.12.20, פירעון ההלוואה (1.7.21) קרוב משנה. לכן, כל קרן ההלוואה עוברת לסעיף התחייבויות שוטפות ("חלויות שוטפות").
              </p>
              ...
              <div className="bg-[var(--surface)] border border-[var(--surface-alt)] rounded-lg p-4">
                <h4 className="font-bold text-[var(--text)] mb-2">הצגה בדוחות הכספיים ליום 31.12.20</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <h5 className="font-semibold text-[var(--text-muted)] mb-1">מאזן</h5>
                    <ul className="space-y-1">
                      <li><span className="font-semibold text-[var(--color-warning)]">התחייבויות שוטפות:</span></li>
                      <li className="pr-4">- חלויות שוטפות של הלוואות: 200,000</li>
                      <li className="pr-4">- ריבית לשלם: 5,000</li>
                      <li className="mt-2 text-rose-400">התחייבויות לזמן ארוך: 0 (אין)</li>
                    </ul>
                  </div>
                  <div>
                    <h5 className="font-semibold text-[var(--text-muted)] mb-1">דוח רווח והפסד</h5>
            ...
            {/* 2021 */}
            <div className="border border-[var(--accent)]/30 bg-[var(--accent)]/5 rounded-xl p-6">
              <h3 className="text-xl font-bold text-[var(--accent)] mb-4 border-b border-[var(--accent)]/20 pb-2">שנת 2021</h3>
              <p className="text-[var(--text-muted)] text-sm mb-4">
              ...
              <div className="bg-[var(--surface)] border border-[var(--surface-alt)] rounded-lg p-4">
                <h4 className="font-bold text-[var(--text)] mb-2">הצגה בדוחות הכספיים ליום 31.12.21</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <h5 className="font-semibold text-[var(--text-muted)] mb-1">מאזן</h5>
                    <ul className="space-y-1">
                      <li className="text-emerald-400">אין יתרות הלוואה או ריבית.</li>
                    </ul>
                  </div>
                  <div>
                    <h5 className="font-semibold text-[var(--text-muted)] mb-1">דוח רווח והפסד</h5>
